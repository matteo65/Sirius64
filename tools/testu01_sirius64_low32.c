/*
 * testu01_sirius64_low32.c
 *
 * Execute TestU01 SmallCrush, Crush and BigCrush on sirius64 (low 32 bits)
 *
 * Copyright(C) 2026 Matteo Zapparoli - zapparoli.matteo@gmail.com
 *
 * SPDX-License-Identifier: Apache-2.0
 *
 * Compile: gcc -std=c99 -Wall -O3 -o testu01_sirius64_low32 testu01_sirius64_low32.c -ltestu01 -lm
 *
 * Sintax:
 *  testu01_sirius64_low32 [(small | crush | big) <seed>]
 *
 * No args prints help
 *
 */
...
unsigned int sirius64low32(void) 
{
...
void usage(void)
{
	printf("testu01_sirius64_low32 - Run TestU01 SmallCrush, Crush and BigCrush on sirius64 (low 32 bits)\n\n");
	printf("Usage: testu01_sirius64_low32 [(small | crush | big) <seed>]\n\n");
}
...
int main(int argc, char *argv[])
{
	...
	unif01_Gen *gen = unif01_CreateExternGenBits("sirius64 low32", sirius64low32);

	printf("=== TestU01 - Generator: sirius64 low32 ===\n");
